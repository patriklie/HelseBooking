...
router.post("/pushvarsler", authMiddleware, validateIdMiddleware, verifyRoleMiddleware("behandler", "pasient"), aktiverPushVarsler);
router.delete("/pushvarsler", authMiddleware, validateIdMiddleware, verifyRoleMiddleware("behandler", "pasient"), deaktiverPushVarsler);
